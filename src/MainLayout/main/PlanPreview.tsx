...
function PlanPreview() {
    ...
    return (
        <SectionCard id="planpreview" className="relative justify-start h-full my-40 z-0">
            <div className="absolute inset-x-0 -top-40 h-40 z-10
                bg-linear-to-t from-transparent via-black/70 to-(--secbackground-color)">
            </div>
